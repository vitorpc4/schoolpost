...
describe('PostService', () => {
    ...
    it('deve trazer os posts por palavra chave', async () => {
        ...
        const result = await postService.findPostByKeyWord(associateIds, search, limit, page);
    ...
    it('deve trazer todos os rascunhos', async () => {
        ...
        const result = await postService.findDraftsByAssociationId(associateIds, page, limit);
    ...
    it('deve trazer todos os posts de uma escola', async () => {
        ...
        const result = await postService.findPostByAssociationId(associateIds, page, limit);
